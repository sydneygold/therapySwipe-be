...
class TherapistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create therapist" do
    assert_difference('Therapist.count') do
      post therapists_url, params: { therapist: { email: @therapist.email, name: @therapist.name, specialized_focus: @therapist.specialized_focus } }, as: :json
    end
  ...
  test "should update therapist" do
    patch therapist_url(@therapist), params: { therapist: { email: @therapist.email, name: @therapist.name, specialized_focus: @therapist.specialized_focus } }, as: :json
    assert_response 200
  end
